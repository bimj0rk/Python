...
X, T = make_blobs(n_samples = 450, centers = 6, n_features = 6, cluster_std = 3.5) #n_features = classes, for 6 no of features is 
#enough to be equal to no of classes, for less, classes should be a smaller number
...
mlp = MLPClassifier(hidden_layer_sizes = (), alpha = 1e-5, tol = 1e-5, solver = "lbfgs", verbose = True, activation = "relu", max_iter = 1000)
mlp.fit(X, T)
