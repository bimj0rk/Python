...
index = 40  # the first 40 images are in order, unshuffled
im = data[index]
imSize = int(len(im) ** .5)
...
mlp = MLPClassifier(hidden_layer_sizes = (20, 20), activation = 'relu', max_iter = 50, alpha = 1e-4, solver = 'sgd', verbose = 1, learning_rate_init = .1)
